...
from vcclient_for_zeroshot_server.core.data_types.slot_manager_data_types import MoveModelParam, ReferenceVoice, ReferenceVoiceImportParam, SetIconParam, VoiceCharacter, VoiceCharacterImportParam
...
class RestAPIVoiceCharacterSlotManager:
    def __init__(self):
        ...
        self.router.add_api_route("/api/voice-character-slot-manager/slots/{index}/voices/{voice_index}/file", self.get_voice_file, methods=["GET"])
        ...
        self.router.add_api_route("/api_voice-character-slot-manager_slots_{index}_voices_{voice_index}_file", self.get_voice_file, methods=["GET"])
    ...
    def get_voice_file(self, index: int, voice_index: int):
        slot_manager = VoiceCharacterSlotManager.get_instance()
        file_path = slot_manager.get_voice_file_path(index, voice_index)
