...
from vcclient_for_zeroshot_server.core.data_types.module_manager_data_types import ModuleDownloadStatus
from vcclient_for_zeroshot_server.utils.is_running_on_colab import is_running_on_colab
